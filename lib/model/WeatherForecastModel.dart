...
class Main {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['temp'] = this.temp?.toDouble();
    data['feels_like'] = this.feelsLike?.toDouble();
    data['temp_min'] = this.tempMin?.toDouble();
    data['temp_max'] = this.tempMax?.toDouble();
    data['pressure'] = this.pressure;
    data['sea_level'] = this.seaLevel;
    data['grnd_level'] = this.grndLevel;
    data['humidity'] = this.humidity;
    data['temp_kf'] = this.tempKf?.toDouble();
    return data;
  }
}
